...
def calc_track_times(path, min_track_len, max_track_len):
    '''
    ...
    :return: Tracks
    '''
    silences = find_silent_sections(path)
...
if __name__ == '__main__':
    ...
    for track in calc_track_times(path, timedelta(minutes=7), timedelta(minutes=10)):
        print("%d  %s - %s" % (track.track_num, track.start, track.end))
